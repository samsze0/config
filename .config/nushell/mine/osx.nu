export def osx-notify [title, body] {
...
def defaults-write [
  ...
  # Example call:
  # defaults-write "-g" "KeyRepeat" "-float" "1.7"
  ^defaults write $domain $key ...$args | ignore
}

export def osx-settings-update [] {
  # Reference:
  ...
  # Reload Dock / System UI / Finder
  ^killall Dock | ignore
  ^killall SystemUIServer | ignore
  ^killall Finder | ignore
}
