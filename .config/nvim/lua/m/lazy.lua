...
-- Creates a wrapper over a table that caches the result of the return value of the handler function
-- for subsequent accessing/calling. The return value of the handler is most likely `require('module')`
---@param t any
