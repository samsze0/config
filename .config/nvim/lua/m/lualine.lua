...
local mode_session = {
  "mode",
  fmt = function(mode) return "" end,
}

local function maximize_status_session() return vim.t.maximized and "Z" or "" end
...
require("lualine").setup({
  options = {
    ...
    section_separators = {
      left = use_triangle_separator and "" or " ",
      right = use_triangle_separator and "" or " ",
    },
    refresh = {
      statusline = 1000,
      tabline = 1000,
