...
if reset_non_treesitter_hl then c = vim.tbl_extend("force", M.colors, reset_non_ts_syntax_hl_tbl) end
...
function M.setup(opts)
  ...
  -- Copilot
  if config.copilot_plugin == "vim" then hi.CopilotSuggestion = { guifg = c.gray_400, guibg = nil } end
  ...
  -- File tree
  if config.filetree_plugin == "nvimtree" then hi.NvimTreeIndentMarker = { guifg = indent_marker, guibg = nil } end
